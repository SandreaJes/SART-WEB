...
function returnMenuLiviano(){	
	var entidad = "setParticionEnseLiviano";
...
function callCtxMiga(){   
   ...
   var cadenaAtributos, streaming = "";
   cadenaAtributos = document.getElementById('nroPrueba').value +";1;5;"+ctxMiga;// el primero es la Tipodelvehiculo, la seccion es ense;anza 		
   streaming = entidad + "|" + cadenaAtributos;
