...
function registroPreIngreso(){
	...
	if (envio == true) {
        ...
        var cadenaAtributos, streaming = ""; 
        streamingDatosAtrr= streamingDatosAtrr+";"+document.getElementById("tipoVehiculo").value+";"+document.getElementById("tiemposMotor").value; 
        cadenaAtributos = streamingDatosAtrr+"%"+strLegalizacion+" ; " ;  
