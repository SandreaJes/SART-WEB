...
function respExistenciaSession(resp){
	...
	if(resp==0){
		...
		optionSession.title ="Sart 2.0.0";
...
function respSetCierrePrueba(resp) {
	optionValidador.title = "Sart 2.0.0";
	if (resp == 1 ) {		
...
function cargaProfundidad(obj) {
	...
	if (validTD == true && validDD ==true) {
		var minTr;
		if (parseFloat(txtTra1.value)< parseFloat(txtTra2.value)) {
			minTr=txtTra1.value;
		...
		if (parseFloat(minTr)> parseFloat(txtTra3.value)) {
			minTr=txtTra3.value;
		}
		console.log('txtTraTD   menor is '+minTr);
		if (parseFloat(minTr)> parseFloat(txtTra4.value)) {
			minTr=txtTra4.value;		
		}
		console.log('txtTraTD  menor is '+minTr);
		var minDr;
		if (parseFloat(txtDen1.value)< parseFloat(txtDen2.value)) {
			minDr=txtDen1.value;
		}else{
			minDr=txtDen2.value;
		}
		...
		if (parseFloat(minDr)> parseFloat(txtDen3.value)) {
			minDr=txtDen3.value;		
		}
		console.log('txtTraDD  menor is '+minDr);
		if (parseFloat(minDr)> parseFloat(txtDen4.value)) {
			minDr=txtDen4.value;
		}
		console.log('txtTraDD  menor is '+minDr);		
