...
function sc(){	
	if (callFunction =="findCtxInspeccion"){
		naturalezaRev= document.getElementById('natRev').value;
		setTimeout(function(){callCTX()},577  );		
	}	
...
function registrarDatosPrerevision(){
	...
	if(envio==true){
		...
		if(document.getElementById("claseVehiculo").value=="MOTOCICLETA" ){			
		 ...
		 var cadenaAtributos, streaming = "";			
		 cadenaAtributos =ctxPreRevision+";"+fkRevision +";"+ document.getElementById("placa").value + ";"+document.getElementById("combustible").value+";"+document.getElementById("modelo").value+";"+document.getElementById("typIndent").value+";"+document.getElementById("cedula").value+";"+document.getElementById("claseVehiculo").value+";"+document.getElementById("tipoServicio").value+";"+document.getElementById("nroEjes").value+";"+document.getElementById("color").value+";"+ctxPreRevision+";"+document.getElementById("nacionalidad").value+";"+naturalezaRev ;
		 streaming = entidad + "|" + cadenaAtributos;		
...
function findCtxRevision() {
	if (document.getElementById("placa").value.length >3){
		 ...
		 options.size='sm-2';
		 eModal.alert(options);		
		 callFunction ="findCtxInspeccion";
	}	
}
var fkRevision=0;
