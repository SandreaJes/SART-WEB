...
function returnMenuLiviano(){	
	var entidad = "setParticionTaxiLiviano";
...
function callCtxMiga(){   
   ...
   var cadenaAtributos, streaming = "";
   alert(cadenaAtributos )
   cadenaAtributos = document.getElementById('nroPrueba').value +";1;6;"+ctxMiga;// el primero es la Tipodelvehiculo, la seccion es Taximetro
   alert(cadenaAtributos )
   streaming = entidad + "|" + cadenaAtributos;
...
function callCtxMigaDef(objCtx){
	...
	var entidad = "servCtxShowDefectos";
	var cadenaAtributos, streaming = "";
	cadenaAtributos = document.getElementById('nroPrueba').value +";1;6;"+objCtx;		
	streaming = entidad + "|" + cadenaAtributos;	
	doAjax('./ServicioBasicoControler.do', streaming,'respCtxShowDefectos', 'get', 0);
}
