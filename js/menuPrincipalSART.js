...
function verStatusPruebas0() {
    ...
    ctxNacionalidad=document.getElementById('ctxNacionalidad0').value;
...
function callResourcePrueba(idPrueba,tipoPrueba,condicion){		
	...
	var cadenaAtributos, streaming = "";
	cadenaAtributos = idPrueba+";"+tipoPrueba+";"+ctxPlaca +";"+ctxTurno+";"+ctxCondicion +";"+ctxTipo +";"+ctxServicio+";"+ctxHojaPrueba +";"+ ctxTipoVehiculo +";"+ ctxNroEjes +";"+ ctxEnsenanza+";"+ctxPoseePacha+";"+ctxNacionalidad;
	streaming = entidad + "|" + cadenaAtributos;
...
function verStatusPruebas1(){
  ...
  ctxNacionalidad=document.getElementById('ctxNacionalidad1').value
	var entidad = "servFindStatusPruebas";
	var cadenaAtributos, streaming = "";
...
function verStatusPruebas2(){
  ...
  ctxNacionalidad=document.getElementById('ctxNacionalidad2').value
  var entidad = "servFindStatusPruebas";
  var cadenaAtributos, streaming = "";
...
function verStatusPruebas3(){
   ...
   ctxNacionalidad=document.getElementById('ctxNacionalidad3').value
  var entidad = "servFindStatusPruebas";
  var cadenaAtributos, streaming = "";
...
function verStatusPruebas4(){
  ...
  ctxNacionalidad=document.getElementById('ctxNacionalidad4').value;
  console.log('ctx nacionalidad '+ctxNacionalidad);
  var entidad = "servFindStatusPruebas";
  var cadenaAtributos, streaming = "";
...
function verStatusPruebas5(){
  ...
  ctxNacionalidad=document.getElementById('ctxNacionalidad5').value
  var entidad = "servFindStatusPruebas";
  var cadenaAtributos, streaming = "";
...
function verStatusPruebas6(){
  ...
  ctxNacionalidad=document.getElementById('ctxNacionalidad6').value  
  var entidad = "servFindStatusPruebas";
  var cadenaAtributos, streaming = "";
...
function verStatusPruebas7(){
  ...
  ctxNacionalidad=document.getElementById('ctxNacionalidad7').value;
  var entidad = "servFindStatusPruebas";
  var cadenaAtributos, streaming = "";
	...
	if(resp.length> 2){
	   ...
	   for(i = 0;  i < flujoHP.length-1;  i++) {
		   ...
		   var newCanvas = document.createElement("canvas");
			newCanvas.setAttribute('width', '129%');
			...
			contexto.beginPath();
			 if (flujoAtrrHP[11] == "N") {
				if (flujoAtrrHP[5] == "Particular") {
					contexto.drawImage(imgPlacaAma, 0, 0, 128, 58);
				} else {
					contexto.drawImage(imgPlacaBlac, 0, 0, 128, 58);
				}
				...
				contexto.drawImage(imgPlacaExtra, 0, 0, 128, 58);
				var str = flujoAtrrHP[1]
				contexto.font = "bold 22px sans-serif";
				contexto.fillText(str, 10, 39);
			}
		    
		    contexto.closePath();	
		    console.log('nacionalidad '+flujoAtrrHP[11]);
		    ...
		    document.getElementById('ctxNacionalidad'+i).value =flujoAtrrHP[11]; 		   
...
function clearMenuMain() {
	...
	for (var i = 0; i < 9; i++) {
		...
		document.getElementById('ctxNacionalidad' + i).value = "";
	}
}
...
function serFindCtxPista(tipoVehiculo) {
	...
	if (document.getElementById('ctxInspeccion').checked == true) {
		document.getElementById('ctxInspeccion').value="2"
	}else{
		document.getElementById('ctxInspeccion').value="1"
	}
	
	var entidad = "servFindHojaPruebasAbiertas";
	var cadenaAtributos, streaming = "";	
	cadenaAtributos = ctxPista+";"+document.getElementById('ctxRevision').value+";"+document.getElementById('ctxInspeccion').value;
